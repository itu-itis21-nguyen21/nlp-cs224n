...
def minibatch_parse(sentences, model, batch_size):
    ...
    # Initialize partial_parses and unfinished_parses
    ...
    while len(unfinished_parses) > 0:
        ...
        # use model.predict() to predict the transition step for each partial_parse in minibatch
        transitions = model.predict(minibatch)
        # conduct parse_step for each partial_parse
